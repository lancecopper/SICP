...
;;; assembly code
;; construct the porcedre and skip over code for the procedure body
    (assign val (op make-compiled-procedure) (label entry2) (reg env))
    (goto (label after-lambda1))

;; calls to factorial will enter here
;; construct the porcedre(iter) and skip over code for the procedure body
entry2
...
;; include (* counter product) in argl
after-call11
    (restore argl)
    (assign argl (op cons) (reg val) (reg argl))
;; restore iter
